...
function parseWorkBlurb(info)
{
    ...
    html    +=      "<p class='col-md-9 col-sm-9 col-lg-9 col-xs-9 work-info'>";
    ...
    html    +=      "</p>";
    html    +=      "<img src='" + 'images/' + png + "' class='work-info-png col-md-3 col-sm-3 col-xs-3 col-lg-3' \>";
    html    += "</li>"
...
function parseOtherBlurb(info)
{
    ...
    html    +=      "<p class='col-md-9 col-sm-9 col-lg-9 col-xs-9 other-info'>";
    ...
    html    +=      "</p>";
    html    +=      "<img src='" + 'images/' + png + "' class='other-info-png col-md-3 col-sm-3 col-xs-3 col-lg-3' \>";
    html    += "</li>"
